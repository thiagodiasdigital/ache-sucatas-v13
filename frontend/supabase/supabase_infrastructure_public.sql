-- ============================================================================
-- ACHE SUCATAS - INFRAESTRUTURA SUPABASE (VERSÃO AJUSTADA)
-- Versão: 1.1.0
-- Data: 2026-01-18
-- Nota: Funções RPC no schema PUBLIC para compatibilidade com frontend
-- ============================================================================
...
-- ============================================================================
-- FASE 3: TABELA DE LEILÕES NO SCHEMA RAW
-- ============================================================================
...
-- ============================================================================
-- FASE 4: RLS (Row Level Security) NA TABELA raw.leiloes
-- ============================================================================
...
COMMENT ON VIEW pub.v_auction_discovery IS 'View de produção para descoberta de leilões';
...
-- ============================================================================
-- FASE 7: FUNÇÕES RPC NO SCHEMA PUBLIC (COMPATÍVEL COM FRONTEND)
-- ============================================================================

-- Função principal: buscar leilões com auditoria
CREATE OR REPLACE FUNCTION public.fetch_auctions_audit(
...
RETURNS TABLE (
    ...
    tags TEXT[],
    link_pncp VARCHAR,
    link_leiloeiro VARCHAR,
    modalidade_leilao VARCHAR,
    valor_estimado DECIMAL,
    quantidade_itens INTEGER,
    nome_leiloeiro VARCHAR,
...
GRANT EXECUTE ON FUNCTION public.fetch_auctions_audit(JSONB) TO authenticated;
GRANT EXECUTE ON FUNCTION public.fetch_auctions_audit(JSONB) TO anon;

COMMENT ON FUNCTION public.fetch_auctions_audit IS 'Busca leilões com filtros e registra log de auditoria';

-- ============================================================================
-- FASE 8: FUNÇÕES AUXILIARES NO SCHEMA PUBLIC
-- ============================================================================
...
GRANT EXECUTE ON FUNCTION public.get_available_ufs() TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.get_cities_by_uf(CHAR) TO authenticated;
...
BEGIN
    ...
    RAISE NOTICE 'RPCs (PUBLIC): fetch_auctions_audit, get_available_ufs, get_cities_by_uf, get_dashboard_stats';
    RAISE NOTICE '========================================';
END $$;
