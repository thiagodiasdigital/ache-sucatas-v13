"""
ACHE SUCATAS MINER V11 - 100% CLOUD-NATIVE
===========================================
Minerador de editais PNCP com storage 100% na nuvem.

NOVIDADES V11 (sobre V10):
- CLOUD STORAGE: PDFs armazenados no Supabase Storage (não mais local)
- ZERO LOCAL: Sem dependência de filesystem local
- GITHUB ACTIONS: Pronto para execução em CI/CD
- DUAL MODE: Pode rodar local (backup) ou cloud-only
...
class Settings:
    """Global configuration constants - V11 CLOUD-NATIVE."""

    # =========================================================================
    # CLOUD CONFIGURATION - V11
    # =========================================================================
...
log = logging.getLogger("AcheSucatas_V11")
...
class MetricsTracker:
    ...
    def print_summary(self):
        log.info("=" * 70)
        log.info("RESUMO DA EXECUÇÃO - MINER V11 CLOUD")
        log.info("=" * 70)
...
# ==============================================================================
# EDITAL PROCESSOR - V11 CLOUD-NATIVE
# ==============================================================================

class EditalProcessor:
    """Process editals with cloud storage (Supabase Storage)."""
    ...
    async def _process_item(self, client: PncpApiClient, item: dict):
        """Process single API search result item - CLOUD NATIVE."""
        ...
        try:
            ...
            # V11: Inserir no Supabase PostgreSQL
    ...
    async def _download_and_upload_single_file(
        ...
        try:
            ...
            # V11: Upload para Supabase Storage
    ...
    async def _insert_to_supabase(self, edital: EditalModel):
        """Insere edital no Supabase PostgreSQL."""
        ...
        try:
            ...
            if sucesso:
                ...
                log.debug(f"Edital {edital.pncp_id} inserido no Supabase")
            else:
...
# ==============================================================================
# MAIN ORCHESTRATOR - V11 CLOUD
# ==============================================================================

class AcheSucatasMiner:
    """Main orchestrator for ACHE SUCATAS mining - V11 CLOUD-NATIVE."""
    ...
    async def run(self):
        """Execute mining process - CLOUD NATIVE."""
        log.info("=" * 70)
        log.info("ACHE SUCATAS MINER V11 - 100% CLOUD-NATIVE")
        log.info("=" * 70)
            ...
            async with PncpApiClient() as client:
                for term in Settings.SEARCH_TERMS:
                    ...
                    for page in range(1, Settings.PAGE_LIMIT + 1):
                        ...
                        log.info(f"  Page {page}: {len(items)} items | Novos: {self.metrics.metrics['editais_novos']} | Storage: {self.metrics.metrics['storage_uploads']}")
